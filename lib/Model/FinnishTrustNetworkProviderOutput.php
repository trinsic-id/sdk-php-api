...
class FinnishTrustNetworkProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the verified individual.              This is only returned if the user authenticated with MobileID (Mobiilivarmenne).
     *
     * @return self
     */
