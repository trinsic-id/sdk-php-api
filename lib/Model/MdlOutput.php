 ...
 */
class MdlOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdlOutput';
    ...
    protected static $openAPITypes = [
        'iaca_root_certificate' => '\Trinsic\Api\Model\MdlOutputCertificateData',
        'document_signer_certificate' => '\Trinsic\Api\Model\MdlOutputCertificateData',
        'document_type' => 'string',
        'name_spaces' => 'array<string,array<string,\Trinsic\Api\Model\MdlOutputFieldData>>'
    ];
    ...
    */
     ...
     *
     * @param \Trinsic\Api\Model\MdlOutputCertificateData $document_signer_certificate Information about the Document Signer Certificate which signed the mDL presented by the user.
     *
     * @return self
     */
     ...
     * Sets document_type
     *
     * @param string $document_type The document type of the mDL presented by the user.              Common values: - \"org.iso.18013.5.1.mDL\" for ISO 18013-5 mDLs - \"com.google.wallet.idcard.1\" for Google Wallet ID Cards
     *
     * @return self
     */
