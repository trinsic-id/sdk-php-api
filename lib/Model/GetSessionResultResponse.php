...
/**
 * GetSessionResultResponse Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetSessionResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSessionResultResponse';
    ...
    */
    ...
    public function setIdentityData($identity_data)
    {
        if (is_null($identity_data)) {
            array_push($this->openAPINullablesSetToNull, 'identity_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('identity_data', $nullablesSetToNull);
            if ($index !== FALSE) {
