...
/**
 * NigeriaNinMatch2Input Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class NigeriaNinMatch2Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NigeriaNinMatch2Input';
    ...
    protected static $openAPITypes = [
        ...
        'sex' => '\Trinsic\Api\Model\NigeriaNinMatch2InputSex',
        'phone_number' => 'string'
    ];
    ...
    */
     ...
     * Gets sex
     *
     * @return \Trinsic\Api\Model\NigeriaNinMatch2InputSex|null
     */
     ...
     * Sets sex
     *
     * @param \Trinsic\Api\Model\NigeriaNinMatch2InputSex|null $sex The user's sex as it appears in their National ID
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The user's phone number as it appears in their National ID (optional). Must be in E.164 international format: \"+234XXXXXXXXX\"
     *
     * @return self
     */
