...
class NetworkApi
{
    ...
    {
        list($response) = $this->identityLookupWithHttpInfo($phone_number, $contentType);
        return $response;
    }

    /**
     * Operation identityLookupWithHttpInfo
     *
     * Lookup Identity
     *
     ...
     */
    public function identityLookupAsync($phone_number, string $contentType = self::contentTypes['identityLookup'][0])
    {
        return $this->identityLookupAsyncWithHttpInfo($phone_number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation identityLookupAsyncWithHttpInfo
     *
     * Lookup Identity
     *
     * @param  string $phone_number (required)
    ...
    /**
     * Create request for operation 'identityLookup'
     *
     * @param  string $phone_number (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['identityLookup'] to see the possible values for this operation
     *
     ...
     */
    public function identityLookupRequest($phone_number, string $contentType = self::contentTypes['identityLookup'][0])
    {

        // verify the required parameter 'phone_number' is set
        if ($phone_number === null || (is_array($phone_number) && count($phone_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $phone_number when calling identityLookup'
            );
        }


        $resourcePath = '/api/v1/network/identities/{phoneNumber}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Recommend Providers
     *
     * @param  \Trinsic\Api\Model\RecommendRequest $recommend_request recommend_request (optional)
     ...
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Trinsic\Api\Model\RecommendResponse|\Trinsic\Api\Model\ValidationResult[]|\Trinsic\Api\Model\FailureMessage
     */
     ...
     * Recommend Providers
     *
     * @param  \Trinsic\Api\Model\RecommendRequest $recommend_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recommendProviders'] to see the possible values for this operation
     *
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Trinsic\Api\Model\RecommendResponse|\Trinsic\Api\Model\ValidationResult[]|\Trinsic\Api\Model\FailureMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function recommendProvidersWithHttpInfo($recommend_request = null, string $contentType = self::contentTypes['recommendProviders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\RecommendResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\RecommendResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\RecommendResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
