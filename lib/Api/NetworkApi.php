...
class NetworkApi
{
    ...
    public function listProviderContractsWithHttpInfo(string $contentType = self::contentTypes['listProviderContracts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\ListProviderContractsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\ListProviderContractsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\ListProviderContractsResponse', []),
