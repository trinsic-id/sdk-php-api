...
/**
 * RecommendProviderInformation Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class RecommendProviderInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecommendProviderInformation';
    ...
    */
     ...
     * Sets regions
     *
     * @param string[] $regions The regions a provider is available in.
     *
     * @return self
     */
     ...
     * Sets countries
     *
     * @param string[] $countries A list of countries, in alpha-2 ISO 3166-1 format, that the provider is available in.
     *
     * @return self
     */
     ...
     * Sets subdivisions
     *
     * @param string[] $subdivisions A list of subdivisions, in ISO 3166-2 format, that the provider is available in.
     *
     * @return self
     */
