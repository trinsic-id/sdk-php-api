...
/**
 * UgandaNidMatch2Input Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class UgandaNidMatch2Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UgandaNidMatch2Input';
    ...
    protected static $setters = [
        ...
        'secondary_id_number' => 'setSecondaryIdNumber',
    ...
    protected static $getters = [
        ...
        'secondary_id_number' => 'getSecondaryIdNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('secondary_id_number', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['secondary_id_number'];
    }

    /**
     * Sets secondary_id_number
     *
     * @param string|null $secondary_id_number The card number on the document (secondary ID number). Required for Uganda Basic KYC instead of first name and last name.
     *
     * @return self
     */
