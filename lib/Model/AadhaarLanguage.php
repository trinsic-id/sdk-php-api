...
/**
 * AadhaarLanguage Class Doc Comment
 *
 * @category Class
 ...
 */
class AadhaarLanguage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AadhaarLanguage';
    ...
    */
     ...
     * Sets language_code
     *
     * @param string|null $language_code The language code for the localized claims.
     *
     * @return self
     */
     ...
     * Sets language_name
     *
     * @param string $language_name The language name for the localized claims.              This is Trinsic attempting to map the language from the code. This is based on the spec, however, the language code may be inaccurate with the actual language used. Use this as a reference. Possible values: - Assamese (01) - Bengali (02) - Gujarati (05) - Hindi (06) - Kannada (07) - Malayalam (11) - Manipuri (12) - Marathi (13) - Oriya (15) - Punjabi (16) - Tamil (20) - Telugu (21) - Urdu (22)
     *
     * @return self
     */
