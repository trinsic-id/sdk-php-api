...
/**
 * SubProviderMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class SubProviderMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubProviderMetadata';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The ID of the sub-provider.              This cannot be used as a standalone Provider ID when creating a Session. It must be passed in via the Provider-specific input.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the sub-provider
     *
     * @return self
     */
