...
class AttachmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The unique identifier of the Attachment.              Pass this to the `GetAttachment` endpoint, along with the Session ID and the `resultsAccessKey` for said Session.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the Attachment.              Possible values: - \"selfie\" - \"document_front\" - \"document_back\" - \"document_portrait\" - \"document_signature\" - \"document_scan_report\"              Additional attachment types may be defined for specific Providers.
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string $content_type The MIME type of the attachment's contents; eg, \"image/jpeg\" or \"application/pdf\".
     *
     * @return self
     */
     ...
     * Sets size_bytes
     *
     * @param int $size_bytes The size in bytes of the attachment.
     *
     * @return self
     */
