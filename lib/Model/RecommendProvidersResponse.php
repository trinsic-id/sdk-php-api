...
/**
 * RecommendProvidersResponse Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class RecommendProvidersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecommendProvidersResponse';
    ...
    */
    ...
    /**
     * Gets recommended_providers
     *
     * @return \Trinsic\Api\Model\RecommendProviderInformation[]
     */
    public function getRecommendedProviders()
    {
        return $this->container['recommended_providers'];
    }

    /**
     * Sets recommended_providers
     *
     * @param \Trinsic\Api\Model\RecommendProviderInformation[] $recommended_providers recommended_providers
     *
     * @return self
     */
    public function setRecommendedProviders($recommended_providers)
    {
        if (is_null($recommended_providers)) {
