...
class AttachmentAccessKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets selfie
     *
     * @param string|null $selfie selfie
     *
     * @return self
     */
    ...
    {
        if (is_null($selfie)) {
            array_push($this->openAPINullablesSetToNull, 'selfie');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('selfie', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets document_front
     *
     * @param string|null $document_front document_front
     *
     * @return self
     */
    public function setDocumentFront($document_front)
    {
        if (is_null($document_front)) {
            array_push($this->openAPINullablesSetToNull, 'document_front');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('document_front', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets document_back
     *
     * @param string|null $document_back document_back
     *
     * @return self
     */
    public function setDocumentBack($document_back)
    {
        if (is_null($document_back)) {
            array_push($this->openAPINullablesSetToNull, 'document_back');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('document_back', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $document_portrait document_portrait
     *
     * @return self
     */
    public function setDocumentPortrait($document_portrait)
    {
        if (is_null($document_portrait)) {
            array_push($this->openAPINullablesSetToNull, 'document_portrait');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('document_portrait', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets provider
     *
     * @return \Trinsic\Api\Model\ProviderAttachments
     */
     ...
     * Sets provider
     *
     * @param \Trinsic\Api\Model\ProviderAttachments $provider provider
     *
     * @return self
     */
