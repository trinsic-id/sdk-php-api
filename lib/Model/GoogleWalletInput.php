...
/**
 * GoogleWalletInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class GoogleWalletInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GoogleWalletInput';
     ...
     *
     * @param \Trinsic\Api\Model\MdlExchangeMechanism|null $exchange_mechanism The exchange mechanism to use for this Google Wallet verification.              Use `DigitalCredentialsApi` for Digital Credentials API on web, or `NativeApp` for a native Android app.
     *
     * @return self
     */
     ...
     *
     * @param \Trinsic\Api\Model\Raw18013RequestInput|null $preview_raw18013_request **Preview feature: not suitable for production use cases**              The raw 18013-7 exchange request to use for this verification.              If set, this overrides any default configuration on your Verification Profile.              NOTE: This parameter has no effect in live mode for Google Wallet verifications. Dynamic requests are currently only supported in test mode for Google Wallet.
     *
     * @return self
     */
