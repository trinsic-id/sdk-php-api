...
/**
 * AppleWalletInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppleWalletInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppleWalletInput';
    ...
    */
     ...
     *
     * @return \Trinsic\Api\Model\MdlExchangeMechanism|null
     */
     ...
     *
     * @param \Trinsic\Api\Model\MdlExchangeMechanism|null $exchange_mechanism The exchange mechanism to use for this Apple Wallet verification.              Use `DigitalCredentialsApi` for Digital Credentials API on web, or `NativeApp` for a native iOS app.
     *
     * @return self
     */
    public function setExchangeMechanism($exchange_mechanism)
    {
        if (is_null($exchange_mechanism)) {
            array_push($this->openAPINullablesSetToNull, 'exchange_mechanism');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('exchange_mechanism', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param \Trinsic\Api\Model\Raw18013RequestInput|null $preview_raw18013_request **Preview feature: not suitable for production use cases**              The raw 18013-7 exchange request to use for this verification.              If set, this overrides any default configuration on your Verification Profile.              NOTE: For Apple Wallet, this cannot (yet) be used with the `NativeApp` (in-app) exchange mechanism. Only the `DigitalCredentialsApi` (web) exchange mechanism supports this input.
     *
     * @return self
     */
