...
class ProvidersApi
{
     ...
     * Get Provider
     *
     * @param  string $provider_id The ID of the provider to retrieve (required)
     ...
     * @return \Trinsic\Api\Model\GetProviderResponse|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails
     */
     ...
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Trinsic\Api\Model\GetProviderResponse|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails|\Trinsic\Api\Model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Trinsic\Api\Model\GetProviderResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Trinsic\Api\Model\GetProviderResponse';
        $request = $this->getProviderRequest($provider_id, $contentType);
    ...
    public function getProviderRequest($provider_id, string $contentType = self::contentTypes['getProvider'][0])
    {
        ...
        $resourcePath = '/api/v1/providers/{providerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * List Providers
     *
     * @param  bool|null $licensed Filter by license status. If not specified, returns all providers. (optional)
     ...
     */
    public function listProviders($licensed = null, string $contentType = self::contentTypes['listProviders'][0])
    {
        list($response) = $this->listProvidersWithHttpInfo($licensed, $contentType);
        return $response;
    }
     ...
     */
    public function listProvidersWithHttpInfo($licensed = null, string $contentType = self::contentTypes['listProviders'][0])
    {
        $request = $this->listProvidersRequest($licensed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProvidersAsync($licensed = null, string $contentType = self::contentTypes['listProviders'][0])
    {
        return $this->listProvidersAsyncWithHttpInfo($licensed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProvidersAsyncWithHttpInfo($licensed = null, string $contentType = self::contentTypes['listProviders'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listProvidersRequest($licensed = null, string $contentType = self::contentTypes['listProviders'][0])
    {
