...
/**
 * ElSalvadorDuiLookupInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class ElSalvadorDuiLookupInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ElSalvadorDuiLookupInput';
     ...
     * Sets date_of_birth
     *
     * @param \DateTime|null $date_of_birth The DUI holder's date of birth. Required to match the correct person in official records.
     *
     * @return self
     */
