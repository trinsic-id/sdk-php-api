...
/**
 * CoteDIvoireNidLookup2Input Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class CoteDIvoireNidLookup2Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CoteDIvoireNidLookup2Input';
    ...
    */
     ...
     * Sets id_number
     *
     * @param string|null $id_number The user's National ID number (NNI) or document number
     *
     * @return self
     */
