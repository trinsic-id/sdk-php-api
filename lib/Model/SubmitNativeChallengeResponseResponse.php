...
/**
 * SubmitNativeChallengeResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class SubmitNativeChallengeResponseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitNativeChallengeResponseResponse';
    ...
    */
     ...
     * Sets session
     *
     * @param \Trinsic\Api\Model\Session $session The Session for which the challenge token was submitted
     *
     * @return self
     */
