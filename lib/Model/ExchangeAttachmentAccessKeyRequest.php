...
/**
 * ExchangeAttachmentAccessKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Connect
 * @author   OpenAPI Generator team
 ...
 */
class ExchangeAttachmentAccessKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExchangeAttachmentAccessKeyRequest';
    ...
    */
    ...
    public function setAttachmentAccessKey($attachment_access_key)
    {
        ...
        if ((mb_strlen($attachment_access_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attachment_access_key when calling ExchangeAttachmentAccessKeyRequest., must be bigger than or equal to 1.');
        }
