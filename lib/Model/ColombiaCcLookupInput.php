...
/**
 * ColombiaCcLookupInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class ColombiaCcLookupInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ColombiaCcLookupInput';
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date Document issue date, in `YYYY-MM-DD` format
     *
     * @return self
     */
