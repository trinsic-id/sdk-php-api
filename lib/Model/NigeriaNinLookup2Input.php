...
/**
 * NigeriaNinLookup2Input Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class NigeriaNinLookup2Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NigeriaNinLookup2Input';
    ...
    */
     ...
     * Sets id_number
     *
     * @param string|null $id_number The user's National ID number (NIN)
     *
     * @return self
     */
