...
**birthdate** | **\DateTime** | The date of birth of the individual. | [optional]
**address** | [**\Trinsic\Api\Model\OneIdProviderAddress**](OneIdProviderAddress.md) | The address of the individual. | [optional]
