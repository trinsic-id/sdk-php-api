...
class FaydaProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'phone_number' => 'string',
        'email' => 'string',
        'address' => '\Trinsic\Api\Model\FaydaProviderAddress'
    ];
     ...
     * Sets birthdate
     *
     * @param \DateTime|null $birthdate The date of birth of the verified individual.              This attribute is only available if registered directly.
     *
     * @return self
     */
     ...
     * Sets gender
     *
     * @param string|null $gender The sex of the verified individual.              Possible values: - Unknown - NotApplicable - Male - Female              This attribute is only available if registered directly.
     *
     * @return self
     */
     ...
     * Sets nationality
     *
     * @param string|null $nationality The nationality of the verified individual as an ISO 3166-1 alpha-2 country code.              This attribute is only available if registered directly.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the verified individual.              This attribute is only available if registered directly.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email The email address of the verified individual.              This attribute is only available if registered directly.
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \Trinsic\Api\Model\FaydaProviderAddress|null
     */
     ...
     * Sets address
     *
     * @param \Trinsic\Api\Model\FaydaProviderAddress|null $address The address of the verified individual.              This attribute is only available if registered directly.
     *
     * @return self
     */
