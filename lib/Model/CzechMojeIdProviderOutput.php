...
class CzechMojeIdProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('isds_id', $data ?? [], null);
     ...
     *
     * @param string|null $subject_identifier The subject identifier (sub) of the verified individual's MojeID account.              This is a unique identifier that represents the individual within the MojeID system.
     *
     * @return self
     */
    ...
    {
        return $this->container['isds_id'];
    }

    /**
     * Sets isds_id
     *
     * @param string|null $isds_id The individual's ISDS identifier (Informační systém datových schránek — Czech data box system), used for official electronic communication with Czech government authorities.
     *
     * @return self
     */
    public function setIsdsId($isds_id)
    {
        if (is_null($isds_id)) {
            array_push($this->openAPINullablesSetToNull, 'isds_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('isds_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['isds_id'] = $isds_id;
     ...
     * Sets is_student
     *
     * @param bool|null $is_student Whether the individual is a student.
     *
     * @return self
     */
    public function setIsStudent($is_student)
    {
        if (is_null($is_student)) {
            array_push($this->openAPINullablesSetToNull, 'is_student');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_student', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
