...
class FrejaProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $relying_party_user_id The relying party identifier for this individual. This is an identifier specific to the individual and the relying party (your service).
     *
     * @return self
     */
