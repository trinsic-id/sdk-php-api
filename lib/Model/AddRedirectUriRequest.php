...
/**
 * AddRedirectUriRequest Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class AddRedirectUriRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddRedirectUriRequest';
    ...
    */
    ...
    public function setUri($uri)
    {
        ...
        if ((mb_strlen($uri) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uri when calling AddRedirectUriRequest., must be bigger than or equal to 1.');
        }
