...
/**
 * CreateHostedProviderSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class CreateHostedProviderSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateHostedProviderSessionRequest';
    ...
    protected static $setters = [
        ...
        'browser_languages' => 'setBrowserLanguages',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('browser_languages', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['redirect_url']) < 1)) {
    ...
    public function setProvider($provider)
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provider when calling CreateHostedProviderSessionRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets redirect_url
     *
     * @param string $redirect_url The Redirect URL to which the user should be sent after the session is complete.
     *
     * @return self
     */
    public function setRedirectUrl($redirect_url)
    {
        ...
        if ((mb_strlen($redirect_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling CreateHostedProviderSessionRequest., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets browser_languages
     *
     * @return string[]|null
     */
    public function getBrowserLanguages()
    {
        return $this->container['browser_languages'];
    }
     ...
     * @return self
     */
    public function setBrowserLanguages($browser_languages)
    {
        if (is_null($browser_languages)) {
            array_push($this->openAPINullablesSetToNull, 'browser_languages');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('browser_languages', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['browser_languages'] = $browser_languages;
