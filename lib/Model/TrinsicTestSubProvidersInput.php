...
/**
 * TrinsicTestSubProvidersInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class TrinsicTestSubProvidersInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrinsicTestSubProvidersInput';
    ...
    */
     ...
     *
     * @param string|null $sub_provider_id The ID of the specific IDP to invoke within the test federated provider.              Valid options are `sub-provider-a` and `sub-provider-b`.              If not specified, the user will be prompted to select one.
     *
     * @return self
     */
