...
/**
 * MdlIdentityData Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class MdlIdentityData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MdlIdentityData';
    ...
    protected static $openAPITypes = [
        'iaca_root_certificate' => '\Trinsic\Api\Model\MdlCertificateData',
        'document_signer_certificate' => '\Trinsic\Api\Model\MdlCertificateData',
        'name_spaces' => 'array<string,array<string,\Trinsic\Api\Model\ExternalMdlFieldData>>'
    ];
    ...
    protected static $setters = [
        'iaca_root_certificate' => 'setIacaRootCertificate',
        'document_signer_certificate' => 'setDocumentSignerCertificate',
    ...
    protected static $getters = [
        'iaca_root_certificate' => 'getIacaRootCertificate',
        'document_signer_certificate' => 'getDocumentSignerCertificate',
    ...
    {
        $this->setIfExists('iaca_root_certificate', $data ?? [], null);
        $this->setIfExists('document_signer_certificate', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Trinsic\Api\Model\MdlCertificateData
     */
    public function getIacaRootCertificate()
    {
        return $this->container['iaca_root_certificate'];
    }

    /**
     * Sets iaca_root_certificate
     *
     * @param \Trinsic\Api\Model\MdlCertificateData $iaca_root_certificate Information about the IACA Root Certificate which signed the Issuer Certificate for this mDL.
     *
     * @return self
     */
    ...
    {
        return $this->container['document_signer_certificate'];
    }

    /**
     * Sets document_signer_certificate
     *
     * @param \Trinsic\Api\Model\MdlCertificateData $document_signer_certificate Information about the Document Signer Certificate which signed the mDL presented by the user.
     *
     * @return self
     */
     ...
     * Gets name_spaces
     *
     * @return array<string,array<string,\Trinsic\Api\Model\ExternalMdlFieldData>>
     */
     ...
     * Sets name_spaces
     *
     * @param array<string,array<string,\Trinsic\Api\Model\ExternalMdlFieldData>> $name_spaces The namespaces, and fields within those namespaces, which were present in the processed mDL.
     *
     * @return self
     */
