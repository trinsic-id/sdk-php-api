...
/**
 * YotiDocumentDetails Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class YotiDocumentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'YotiDocumentDetails';
    ...
    */
     ...
     *
     * @param string|null $issuing_country The issuing country's ISO alpha-3 code
     *
     * @return self
     */
     ...
     *
     * @param string|null $document_number The arbitrary document number for the provided document type
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_date The document's expiration date in YYYY-MM-DD format
     *
     * @return self
     */
     ...
     *
     * @param string|null $issuing_authority The document's issuing authority. This can either be a country code as a specified ISO alpha-3 or the name of the issuing authority.
     *
     * @return self
     */
