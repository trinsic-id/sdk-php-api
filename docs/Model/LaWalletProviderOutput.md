...
**issue_date** | **\DateTime** | The issue date of the driver&#39;s license used to create the LA Wallet credential |
**expiration_date** | **\DateTime** | The expiration date of the driver&#39;s license used to create the LA Wallet credential |
...
**date_of_birth** | **\DateTime** | The date of birth from the LA Wallet credential |
