...
class Provider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'supported_languages' => '\Trinsic\Api\Model\ProviderSupportedLanguage[]',
     ...
     *
     * @return \Trinsic\Api\Model\ProviderSupportedLanguage[]|null
     */
     ...
     *
     * @param \Trinsic\Api\Model\ProviderSupportedLanguage[]|null $supported_languages Languages supported by this Provider's Trinsic-hosted UI, as BCP 47 language codes.
     *
     * @return self
     */
    public function setSupportedLanguages($supported_languages)
    {
        if (is_null($supported_languages)) {
            array_push($this->openAPINullablesSetToNull, 'supported_languages');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supported_languages', $nullablesSetToNull);
            if ($index !== FALSE) {
