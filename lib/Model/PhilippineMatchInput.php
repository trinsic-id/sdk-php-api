...
/**
 * PhilippineMatchInput Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class PhilippineMatchInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhilippineMatchInput';
    ...
    */
     ...
     * Sets given_name
     *
     * @param string|null $given_name The user's given / first name
     *
     * @return self
     */
     ...
     * Sets family_name
     *
     * @param string|null $family_name The user's family / last name
     *
     * @return self
     */
