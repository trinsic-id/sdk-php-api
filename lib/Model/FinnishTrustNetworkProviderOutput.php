...
/**
 * FinnishTrustNetworkProviderOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class FinnishTrustNetworkProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FinnishTrustNetworkProviderOutput';
    ...
    protected static array $openAPINullables = [
        ...
        'unique_identification_number' => true,
        'given_name' => true,
        'family_name' => true,
    ...
    protected static $setters = [
        ...
        'unique_identification_number' => 'setUniqueIdentificationNumber',
    ...
    protected static $getters = [
        ...
        'unique_identification_number' => 'getUniqueIdentificationNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unique_identification_number', $data ?? [], null);
    ...
    /**
     * Gets unique_identification_number
     *
     * @return string|null
     */
    public function getUniqueIdentificationNumber()
    {
        return $this->container['unique_identification_number'];
    }

    /**
     * Sets unique_identification_number
     *
     * @param string|null $unique_identification_number The 9-digit Finnish Unique Identification Number (FINUID, or sähköinen asiointitunnus SATU) of the verified individual. This number is typically used for online transactions and unlike the Finnish Personal Identification Code, does not reveal personal information such as birthdate.              The first 8 digits are randomly generated and the last character is a check control.
     *
     * @return self
     */
    public function setUniqueIdentificationNumber($unique_identification_number)
    {
        if (is_null($unique_identification_number)) {
            array_push($this->openAPINullablesSetToNull, 'unique_identification_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('unique_identification_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['unique_identification_number'] = $unique_identification_number;
     ...
     * Sets bank
     *
     * @param string|null $bank The bank used to perform the identification for the verified individual.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number of the verified individual.              This is only returned if the individual authenticated with MobileID (Mobiilivarmenne).
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_name The organization name that the individual is associated with.              This is returned for requests that contain the organization scope.
     *
     * @return self
     */
     ...
     * Sets vat_number
     *
     * @param string|null $vat_number The VAT number of the organization that the individual is associated with.              This is returned for requests that contain the organization scope.
     *
     * @return self
     */
