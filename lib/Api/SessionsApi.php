...
class SessionsApi
{
    ...
    public function cancelSessionWithHttpInfo($session_id, string $contentType = self::contentTypes['cancelSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Trinsic\Api\Model\ProblemDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\ProblemDetails' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\ProblemDetails', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
     ...
     *
     * @param  \Trinsic\Api\Model\CreateAdvancedProviderSessionRequest $create_advanced_provider_session_request create_advanced_provider_session_request (optional)
     ...
     * Create Advanced Provider Session
     *
     * @param  \Trinsic\Api\Model\CreateAdvancedProviderSessionRequest $create_advanced_provider_session_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvancedProviderSession'] to see the possible values for this operation
     *
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createAdvancedProviderSessionWithHttpInfo($create_advanced_provider_session_request = null, string $contentType = self::contentTypes['createAdvancedProviderSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\CreateAdvancedProviderSessionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\CreateAdvancedProviderSessionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\CreateAdvancedProviderSessionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     *
     * @param  \Trinsic\Api\Model\CreateHostedProviderSessionRequest $create_hosted_provider_session_request create_hosted_provider_session_request (optional)
     ...
     * Create Hosted Provider Session
     *
     * @param  \Trinsic\Api\Model\CreateHostedProviderSessionRequest $create_hosted_provider_session_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createHostedProviderSession'] to see the possible values for this operation
     *
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createHostedProviderSessionWithHttpInfo($create_hosted_provider_session_request = null, string $contentType = self::contentTypes['createHostedProviderSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\CreateHostedProviderSessionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\CreateHostedProviderSessionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\CreateHostedProviderSessionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     *
     * @param  \Trinsic\Api\Model\CreateWidgetSessionRequest $create_widget_session_request create_widget_session_request (optional)
     ...
     * Create Widget Session
     *
     * @param  \Trinsic\Api\Model\CreateWidgetSessionRequest $create_widget_session_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWidgetSession'] to see the possible values for this operation
     *
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createWidgetSessionWithHttpInfo($create_widget_session_request = null, string $contentType = self::contentTypes['createWidgetSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\CreateWidgetSessionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\CreateWidgetSessionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\CreateWidgetSessionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @param  \Trinsic\Api\Model\RefreshStepContentRequest $refresh_step_content_request refresh_step_content_request (optional)
     ...
     * @param  \Trinsic\Api\Model\RefreshStepContentRequest $refresh_step_content_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['refreshStepContent'] to see the possible values for this operation
     *
     * @throws \Trinsic\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function refreshStepContentWithHttpInfo($acceptance_session_id, $refresh_step_content_request = null, string $contentType = self::contentTypes['refreshStepContent'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Trinsic\Api\Model\RefreshStepContentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Trinsic\Api\Model\RefreshStepContentResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Trinsic\Api\Model\RefreshStepContentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
