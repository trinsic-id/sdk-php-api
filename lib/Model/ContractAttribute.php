...
/**
 * ContractAttribute Class Doc Comment
 *
 * @category Class
 ...
 */
class ContractAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractAttribute';
    ...
    */
     ...
     * Sets scope
     *
     * @param string $scope The scope of the attribute as it appears in verification results.
     *
     * @return self
     */
     ...
     * Sets outputted
     *
     * @param \Trinsic\Api\Model\AttributeAvailability $outputted Indicates when this attribute will be present in verification results.
     *
     * @return self
     */
