...
/**
 * OneIdProviderAddress Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class OneIdProviderAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OneIdProviderAddress';
    ...
    */
     ...
     * Sets street_address
     *
     * @param string|null $street_address The line or street portion of the address.
     *
     * @return self
     */
     ...
     * Sets locality
     *
     * @param string|null $locality The locality or city portion of the address.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region or subdivision portion of the address.
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code The alpha-2 country code of the address.
     *
     * @return self
     */
